...
RUN /bin/bash -c './opt/ros/noetic/setup.bash; catkin_init_workspace /home/ros/worksapce/src'
RUN /bin/bash -c './opt/ros/noetic/setup.bash; cd /home/ros/workspace; catkin_make'
ADD bashrc /.bashrc
